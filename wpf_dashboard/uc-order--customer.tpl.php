 ...
 * Dpm($order, "order");.
 */
// dpm(get_defined_vars(), "defined variables");
// dpm($uc_addresses_shipping_ucxf_job_po_number, "uc_addresses_shipping_ucxf_job_po_number");
// See if this returns the info I need
// $order_full = uc_order_load($order->order_id);
// dpm($order_full, "order full");.
/**
 * @file
        ...
        <tr valign="top">
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              ...
              <?php if (isset($uc_addresses_shipping_ucxf_job_po_number)) { ?>
              <tr>
                <td nowrap="nowrap">
                  <b><?php print t('Job/PO Number:'); ?></b>
                </td>
                <td width="98%">
                  <?php print $uc_addresses_shipping_ucxf_job_po_number; ?>
                </td>
              </tr>
              <?php } // end if $uc_addresses_shipping_ucxf_job_po_number)) {   ?>
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                      <td colspan="2">
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;" border=0>
                          ...
                          <tr><td colspan=2>
                            <b>Order Comments:</b> <?php print $order_comments; ?>
                          </td></tr>
                        </table>
